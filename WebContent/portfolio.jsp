...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li>
                            <a href="#"><i class="fa fa-download fa-fw"></i>Import Transactions</a>
                        </li>
                        <li>
                ...
                <%}%>
                <li>
                    <a href="#new-portfolio" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus fa-fw"></i>New Portfolio</a>
                </li>
                <li>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label id="optStockValue<%out.print(i);%>"><%out.print(stocks.get(i).getStockPrice());%></label>
                                                    </td>
                                                    <td>
                                                        <label id="optExpectedReturn<%out.print(i);%>"><%out.print(String.format("%.02f", stocks.get(i).getExpectedReturn()));%></label>
                                                    </td>
                                                    <td>
                                                        <label id="optRisk<%out.print(i);%>"><%out.print("Risky");%></label>
                                                    </td>
                                                </tr>
                                                <%}%>
                                                </tbody>
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data.unitPrice == null){
                        ...
                        totalPrice.text(data.unitPrice);    
                    }
                },
                error: function(){
    ...
    $('#optimize').click(function (){
        ...
        $("#optimizationTable").find('tr').each(function (i) {
            ...
            array.push({symbol:symbol,type:type,currentValue:currentValue,expectedReturn:expectedReturn});
        });
    ...
    $("input[id^='bsShares']").on("slideStop", function(slideEvt) {
        ...
        $(this).closest('tr').find("label[id^='bsSpent']").text(slideEvt.value * unitPrice);
    ...
    function submitBuySellStocks(thisObj, thisEvent) {
        ...
        $("#bsTable").find('tr').each(function (i) {
            ...
            if(totalValue != 0){
                var symbol = $(this).closest('tr').find("label[id^='bsSymbol']").text();
